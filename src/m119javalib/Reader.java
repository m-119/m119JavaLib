...
public class Reader {
	...
	for (int i = 0; i < text.length; i++) {
		...
		if (str2.equals("("))
		{
		    ...
		    //это конструктор
		    if (str1.equals(classCollection.get(classCollection.size() - 1).getName())){classCollection.get(classCollection.size() - 1).lastMethod().constructor();}
		    ...
		    if (!str3.equals(")"))
		    {
			  classCollection.get(classCollection.size() - 1).lastMethod().getArgs().add(str3);
			    ...
			    if (!text[i].equals(",")){classCollection.get(classCollection.size() - 1).lastMethod().getArgs().add(text[i]);}
			    }
		    }
		    ...
		    {
			i++;
			if(text[i].equals("\n")&count_brace==0){continue;}
			
			if(text[i].equals("{")){count_brace++; i++;}
			else if(text[i].equals("}")){count_brace--;}
			if(count_brace == 0){break;}
		...
		else if (str3.equals("("))
		{
		    ...
		    //это конструктор
		    if (str2.equals(classCollection.get(classCollection.size() - 1).getName())){classCollection.get(classCollection.size() - 1).lastMethod().constructor();}
